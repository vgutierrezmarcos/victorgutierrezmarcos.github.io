...
htmlwidgets::saveWidget(viviendas_plt, "images/temp.html", selfcontained = TRUE)
webshot2::webshot("images/temp.html", "images/20260129_viviendas.png")

# Delete a file
if (file.exists("images/temp.html")) file.remove("images/temp.html")
# Delete a folder (and its contents)
if (dir.exists("images/temp_files")) unlink("images/temp_files", recursive = TRUE) 
```
